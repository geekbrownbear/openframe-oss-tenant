...
export function CustomerTicketsTabSkeleton() {
  return <TicketsTableSkeletonInner titleWidth="w-32" actionWidth="w-[160px]" />;
}

export function CustomerLogsTabSkeleton() {
  return <LogsTableSkeletonInner titleWidth="w-24" actionWidth="w-[120px]" />;
}

export function getCustomerTabSkeleton(activeTab: string) {
  switch (activeTab) {
    case 'tickets':
      return <CustomerTicketsTabSkeleton />;
    case 'logs':
      return <CustomerLogsTabSkeleton />;
    case 'details':
      return <CustomerDetailsTabSkeleton />;
    default:
      return <CustomerDevicesTabSkeleton />;
  }
}

interface CustomerDetailsSkeletonProps {
  activeTab?: string;
}

/**
 * Full-page skeleton matching `CustomerDetailsView`'s PageLayout structure:
